...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/email-register", name: "email-register", component: () => import("../views/EmailRegisterView.vue") },
    ...
    { path: "/publish", name: "publish", component: () => import("../views/PublishSelectView.vue"), meta: { auth: true } },
    { path: "/publish-product", name: "publish-product", component: () => import("../views/PublishProductView.vue"), meta: { auth: true } },
    { path: "/publish-wanted", name: "publish-wanted", component: () => import("../views/PublishWantedView.vue"), meta: { auth: true } },
    { path: "/publish-post", name: "publish-post", component: () => import("../views/PublishPostView.vue"), meta: { auth: true } },
    { path: "/my-publish", name: "my-publish", component: () => import("../views/MyPublishView.vue"), meta: { auth: true } },
